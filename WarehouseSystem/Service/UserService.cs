...
namespace WarehouseSystem.Service
{
    public class UserService : IUserService
    {
        ...
        public UserService(IRepository<CST_USER_PROFILE> repository)
        {
            _repository = repository;
        }

        public IResult Create(string UserID, string Password, ref string UserProfileID)
        {
        ...
        private void CheckMailGroupDTL(CST_USER_PROFILE UserProfile)
        {
        ...
        public IResult Delete(string UserProfileID)
        {
            ...
            try
            {
                ...
                string sqlString = string.Format(@"Delete CST_MAIL_GRP_DTL Where UserProfileID ='{0}'", UserProfileID);
        ...
        {
            return _repository.GetAll().Any(x => x.UserProfileID == UserProfileID);
        }

        public CST_USER_PROFILE GetBySID(string UserProfileID)
        {
            return _repository.Get(x => x.UserProfileID == UserProfileID);
        }

        public CST_USER_PROFILE GetByUserID(string UserID)
        {
            return _repository.Get(x => x.UserID == UserID);
        }

        public IEnumerable<CST_USER_PROFILE> GetAll()
        {
