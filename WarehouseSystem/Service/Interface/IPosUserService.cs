...
namespace WarehouseSystem.Service.Interface
{
    public interface IPosUserService
    {
        ...
        /// <returns></returns>
        IResult Create(string UserID, string Password, string Title,ref string UserProfileID);
        ...
        /// <param name="UserProfileID"></param>
        /// <returns></returns>
        POS_Employee GetBySID(string UserProfileID);

        /// <summary>
        /// 取得所有帳號資料
        /// </summary>
        /// <returns></returns>
        IEnumerable<POS_Employee> GetAll();
